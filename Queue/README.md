# Microsoft Azure Storage Queue SDK for .NET (9.4.0-preview)
...
- .NET Framework 4.5: As of December 2016, Storage Client Libraries for .NET supports primarily the desktop .NET Framew
